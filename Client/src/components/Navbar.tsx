      ...
      <nav className="bg-amber-400 py:5 lg:py-5 relative ">
        <div className="container mx-auto flex px-0 xl:px-0" >
          ...
          <div className='flex flex-grow'>
            <img src="Group 36.png" alt='logo' className="w-40 h-auto md-6  lg:w-60 lg:mt-[-35px] " />
          </div>
          ...
          <div className="lg:flex hidden flex-grow justify-between">
            ...
            <div className=' mt-9'>
            <Link to="/loginregister" className="bg-amber-300 text-black border border-white py-2 px-5 rounded-md hover:border-transparent hover:text-yellow-500 hover:bg-white transition ease-in duration-500">Admin</Link>
